...
class KnownModels(StrEnum):
    ...
    SECBERT_INSTRUCTIONAL = "SecBERT Instructional"  # HuggingFace model name for SecBERT Instructional
...
class KnownModelUrls(StrEnum):
    ...
    SECBERT_INSTRUCTIONAL = "jackaduma/SecBERT-Instructional"  # HuggingFace repository
...
class BASE_MODELS:
    ...
    SECBERT_INSTRUCTIONAL = HackerModel(
        name=KnownModels.SECBERT_INSTRUCTIONAL.value,
        choice_name="SecBERT Instructional (Cybersecurity BERT, HuggingFace)",
        url=KnownModelUrls.SECBERT_INSTRUCTIONAL.value,
        file_location=None,  # HuggingFace models are loaded by name
    )

    def get_model_inventory() -> List[HackerModel]:
        return [BASE_MODELS.PHI2, BASE_MODELS.SECBERT_INSTRUCTIONAL]
